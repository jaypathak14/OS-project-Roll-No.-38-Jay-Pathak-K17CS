...
struct process // Making a struct to hold the given input
{
      char process_name;
...
void Arrival_Time_Sorting() /*Writing comparator function to sort according to priority if  
...
void main()
{
      ...
      scanf("%d", &limit);
      for(i = 0, c = 'A'; i < limit; i++, c++) //taking the inputs
      {
      ...
      Arrival_Time_Sorting(); //calling method
